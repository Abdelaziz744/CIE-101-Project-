...
{
	pGame->printMessage("Restart clicked. Restart action will be implemented later.");
}
...
{
	pGame->printMessage("Exit clicked.");
}
...
{
	pGame->printMessage("Pause clicked. Pause action will be implemented later.");
}
...
{
	pGame->printMessage("Resume clicked. Resume action will be implemented later.");
}
...
{
	pGame->printMessage("Save clicked. Save action will be implemented later.");
}
...
{
	pGame->printMessage("Load clicked. Load action will be implemented later.");
}
